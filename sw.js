const CACHE='vocal-pitch-editor-v32-voiceover-note-navigation';
...
self.addEventListener('install',e=>e.waitUntil((async()=>{await caches.open(CACHE).then(c=>c.addAll(SHELL));await self.skipWaiting();})()));
